...
export default function Player() {
    ...
    const [ togglePlayerState, setTogglePlayerState ] = useState(true)
    ...
    return (
        ...
        <button className={styles.togglePlayer} onClick={() => setTogglePlayerState(!togglePlayerState)}>
            &gt;
        </button>

        <div className={togglePlayerState ? styles.playerContainer : styles.playerContainerClosed }>
